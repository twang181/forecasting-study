...
class InteractiveForecast:
    def __init__(self):
        ...
        self.forecast_lower = simulated_df[f"Series{self.series_index}_lower"].values
        self.forecast_upper = simulated_df[f"Series{self.series_index}_upper"].values
    ...
    def add_bar(self, x_pos):
        ...
        bar = self.ax.bar(x_pos, upper - lower, bottom=lower, width=0.5, color='skyblue', edgecolor='black', alpha=0.4)[
            0]
