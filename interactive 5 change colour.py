...
class InteractiveForecast:
    def __init__(self):
        ...
        self.ax.set_title(f"Time Series: Series{series_index}")
    ...
    def update_colors(self):
        """Updates colors of bounds based on their positions."""
