...
#New ver: do not present upper and lower bound, but only point forecasts; let ppts predict upper and lower bound
...
class InteractiveForecast:
    def __init__(self):
        ...
        # **Plot past 95% CI as small points (no connecting line)**
        ...
        last_lower, last_upper = self.y_lower[-1], self.y_upper[-1]
    ...
    def save_data(self, event):
        ...
        print("Saved Forecasts:", forecast_results)  # Store in file or database
